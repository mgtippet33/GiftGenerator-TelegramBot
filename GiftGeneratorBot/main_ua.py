...
criteria = Criteria()
interests = { "Спорт \U0001F3C3\U0000200D\U00002642\U0000FE0F": True, "Фотографія \U0001F4F7": True, "Соціальні мережі \U0001F4F1": True, "Мода \U0001F457": True,
             "Подорожі \U00002708": True, "Аніме \U0001F1F0\U0001F1F7": True, "Музика \U0001F3B8": True, "Кіно \U0001F39E": True,  "Комікси \U0001F4D6": True,
             "Технології \U0001F4BB": True, "Театр \U0001F3AD": True, "Програмування \U0001F468\U0000200D\U0001F4BB": True, "Косметика \U0001F484": True,
             "Одяг \U0001F9E5": True, "Моделінг \U0001F460": True, "Комп'ютерні ігри \U0001F5A5": True, "Фітнес \U0001F9D8": True,
             "Анімація \U0001F305": True, "Кулінарія \U0001F958": True, "Навчання \U0001F4DA": True, "Автомобілі \U0001F697": True, "Тварини \U0001F436": True,
...
def errorMessage(userid, mode="default"):
    ...
    if mode == "age-outside":
        ...
        errmsg = "Вибачте, але я поки можу аналізувати тільки соціальні мережі Facebook та Twitter.\n" \
